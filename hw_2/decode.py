...
optparser.add_option("-i", "--input", dest="input", default="data/examples.clean.ch", help="File containing sentences to translate (default=data/input)")
optparser.add_option("-t", "--translation-model", dest="tm", default="data/phrase-table", help="File containing translation model (default=data/tm)")
